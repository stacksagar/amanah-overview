  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.from('.manifesto-quote', {
        opacity: 0, x: -20, duration: 1.1, ease: 'power3.out',
        ...
        <div className="manifesto-body-wrap grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20">
          <div className="space-y-5">
            <p className="manifesto-body text-dim font-sans font-light leading-relaxed text-[clamp(0.9rem,1.2vw,1.05rem)]">
              For generations, wealth demanded constant vigilance. Emotions clouded
              decisions. Opportunity costs compounded silently. The system profited
              from your distraction.
            </p>
            <p className="manifesto-body text-dim font-sans font-light leading-relaxed text-[clamp(0.9rem,1.2vw,1.05rem)]">
              We built Amanah on one foundational belief: your wealth deserves the
              same relentless care you give everything you love — without requiring
              your constant presence.
            </p>
          </div>

          <div className="border-l border-border pl-10">
            <blockquote className="manifesto-quote font-serif text-[clamp(1.2rem,2.2vw,2rem)]
                                   font-medium italic leading-snug text-paper/90">
              &ldquo;No management fees. No administrative charges. We participate
              only in success. No performance, no compensation.&rdquo;
            </blockquote>
            <p className="manifesto-quote mt-6 text-[9px] tracking-[0.4em] uppercase text-dim font-sans">
              The Amanah Alignment Model
            </p>
          </div>
        </div>
      </div>
